...
const config: SiteConfig = {
  ...
  socialCardAvatarImage: './src/content/profile.jpeg',
  ...
  socialLinks: {
    github: 'https://github.com/ricoputrap',
    mastodon: '',
    email: '',
    linkedin: 'https://www.linkedin.com/in/ricoputrap/',
    bluesky: '',
    twitter: 'https://x.com/rico_rpp21',
